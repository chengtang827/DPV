...
Args = struct('Level','','Cell',0,'Channel',0,'Array',0,'Sort',0,'HighPass',0, ...
	'Eye',0, 'EyeFilt',0,'Lfp',0,'Session',0,'Day',0,'Days',0, ...
    'LevelPrefix','','CellPrefix',0,'ChannelPrefix',0, ...
...
Args.flags = {'Cell','Channel','Array','Sort','HighPass','Eye','EyeFilt','Lfp', ...
...
nptDataDir = '';
levelName = lower({'Cell','Channel','Array','Session','Day','Days'});
levelAbbrs = 'cgns';
...
elseif(Args.ShortName)
    ...
    if(isempty(strfind(dname,comboDName)))
		...
		% fprintf('length(a): %d, levell: %d, thislevel: %d\n', length(a), levell, thislevel)
