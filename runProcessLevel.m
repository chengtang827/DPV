...
for i = 1:size(channelId,1)-1
    ProcessLevel(rplsplit,'Levels','Day','SaveLevels',3,...
        'SkipLFP',1,'UseHPC',1,'Channels',channelId{i,1},...
        'HPCCmd','source ~/.bash_profile; qsub $GITHUB_MATLAB/Hippocampus/Compiler/rplsplit/rsHPC_submit_file.txt')
end

ProcessLevel('checkSkippingFlag',1,rplsplit,'Levels','Day','SaveLevels',3,...
    'SkipLFP',1,'UseHPC',1,'Channels',channelId{end,1},...
    'HPCCmd','source ~/.bash_profile; qsub $GITHUB_MATLAB/Hippocampus/Compiler/rplsplit/rsHPC_submit_file.txt')
end
