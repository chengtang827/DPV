...
if(~isa(p,classname))
    ...
    elseif(isempty(q))
		...
		r.data.cellNames = {p.data.cellNames{:} q.data.cellNames{:}};
		r.data.numCells = p.data.numCells + q.data.numCells;
		r.data.numCellsIndex = [p.data.numCellsIndex; ...
			(p.data.numCellsIndex(end) + q.data.numCellsIndex(2:end))];
