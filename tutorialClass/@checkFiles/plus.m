...
% 			+ q.data.setIndex(2:end))];
        r.data.nfile = [p.data.nfile; q.data.nfile];
		r.data.nmat = [p.data.nmat; q.data.nmat];
        r.data.nbin = [p.data.nbin; q.data.nbin];
        r.data.ntxt = [p.data.ntxt; q.data.ntxt];
        r.data.fdir = {p.data.fdir{:} q.data.fdir{:}};
